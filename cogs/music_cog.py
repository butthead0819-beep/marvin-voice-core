...
class MusicCog(MusicCommandsMixin, MusicSubsystemMixin, MusicPersonalShuffleMixin, MusicAudioMetaMixin, MusicAutopilotMixin, MusicStoryArcMixin, commands.Cog):
