...
class MusicCog(MusicCommandsMixin, MusicSubsystemMixin, MusicPersonalShuffleMixin, MusicAudioMetaMixin, MusicAutopilotMixin, MusicStoryArcMixin, MusicDJLyricsMixin, commands.Cog):
