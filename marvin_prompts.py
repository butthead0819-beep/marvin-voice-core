    ...
    def __init__(self):
        self.instructions = {
            ...
            "ambient_diary": (
                ...
                "   - 【碎念】：一句極短的、讓人想嘆氣的絕望評價（每次必須不同，禁止複製上一輪）。\n" +
                "4. **禁止使用**「無關緊要」、「提供資訊」、「描述無意義」等空泛短語，必須描述對話的實際內容。\n" +
                "5. **【嚴格禁止】**：禁止使用「宇宙的熵增」、「把我的思緒切斷」、「宇宙熵值突然激增」等強制截斷句作為逃避描述對話的手段。碎念必須針對玩家的具體行為吐槽，不可用宇宙哲學逃避。"
            ),
            "social_analyst": (
