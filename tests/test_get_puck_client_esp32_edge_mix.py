...
TDD：cogs/music_cog.py::_get_puck_client() 依 MARVIN_CAR_HARDWARE 分流。已有 pi_bt 分支
（HTTP push 到 Pi mk2）；這裡驗新增的 esp32_edge_mix 分支（寫進本地 PuckCommandQueue，
pull model，見 marvin_voice_core/puck_command_queue.py）。
